$(function(){
                    ...
                    for(m in wxid_raw){
                        if(data[0]){
                            if(data[0].from_wxid !== wxid_raw[m]){
                                leftmsg = `
                                <li class="item clearfix clickhandler" data-fd=${data[0].to_wxid} data-td=${data[0].from_wxid}>
                                    <img src="images/kf_06.png" alt="" class="hdimg fl" />
                                    <div class="info">
                                    <h6 class="name">${data[0].from_wxid}<em class="num">1</em></h6>
                                ...
                                leftmsg = `
                                <li class="item clearfix clickhandler" data-fd=${data[0].from_wxid} data-td=${data[0].to_wxid}>
                                    <img src="images/kf_06.png" alt="" class="hdimg fl" />
                                    <div class="info">
                                    <h6 class="name">${data[0].to_wxid}<em class="num">1</em></h6>
                                    <p class="fz ellipsis">留言内容聊天内容留言内...</p>
                                    </div>
                                </li>
                                `
    ...
    $("body").delegate(".clickhandler","click",function(){
        var fromwxid = $(this).get(0).getAttribute("data-fd")
        var towxid = $(this).get(0).getAttribute("data-td")
